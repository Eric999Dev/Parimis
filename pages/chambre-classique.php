...
<main id="bedroom">
    ...
    <div class="cc">
        ...
        <div class="flexslider">
            <ul class="slides">
                <li data-thumb="../imgs/chambres/classique/slide/1.jpg">
                    <img src="../imgs/chambres/classique/slide/1.jpg" alt="chambre classique" />
                </li>
                <li data-thumb="../imgs/chambres/classique/slide/2.jpg">
                    <img src="../imgs/chambres/classique/slide/2.jpg" alt="sdb classique 1" />
                </li>
                <li data-thumb="../imgs/chambres/classique/slide/3.jpg">
                    <img src="../imgs/chambres/classique/slide/3.jpg" alt="sdb classique 2" />
                </li>
                <li data-thumb="../imgs/chambres/classique/slide/4.jpg">
                    <img src="../imgs/chambres/classique/slide/4.jpg" alt="petit-dej" />
                </li>
            </ul>
        </div>
    ...
    <aside>
        ...
        <div class="liens-chambres">
            <div class="link-confort"><a href="chambre-confort.html" title="lien vers confort Parimis"><img src="../imgs/chambres/confort/vignette.jpg" alt="chambre confort" title="confort parimis"></a>
